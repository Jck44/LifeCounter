...
import com.mio.lifecounter.util.SystemUiHider;
...
public class FullscreenActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) { 	
        ...
        //TextView lifePOne = (TextView) findViewById(R.id.lifePOne);
        ...
        /*lifePOne.setOnClickListener(new View.OnClickListener() {
    ...
    class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onFling(MotionEvent event1, MotionEvent event2, 
        	...
        	else if(velocityX < -1000.00 && velocityX < 0.00)
        		clickTest(-5);
        	/*else if(velocityX > -2000.00 && velocityX < 0.00)
        		clickTest(-1);
        	else if(velocityX < 2000.00 && velocityX > 0.00)
        		clickTest(1);
        	else if(velocityX < 5000.00 && velocityX > 0.00)
        		clickTest(5);
        	else if(velocityX < 12000.00 && velocityX > 0.00)
        		clickTest(10);
        	else
        		return false;*/
        	return true;
